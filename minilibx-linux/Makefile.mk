...
CFLAGS	= -lXfixes -O3  -I$(INC)

all	: start_build_aff $(NAME)

.PHONY:start_build_aff
start_build_aff:
	@echo "\n${_BOLD}${_RED}Start Building  ⚙️  🛠️  ⚙️ 	${_GREEN}${_UNDER}$(NAME_UNAME)${_END} :"
...
$(NAME)	: $(OBJ)
	@echo "    ${_BOLD}${_GREEN}🗂️  ◀◀◀ ${_LIME}Creating Archive 📑📑📑   ${_YELLOW}$(BONUS_NAME)${_END}"
...
clean	:
	...
	@echo "    ${_RED}${_BOLD}🗑️  ◀◀◀ Deleting files 🚮 ${_YELLOW}$(OBJ_DIR)/ $(NAME) $(NAME_UNAME) *~ core *.core${_END}\n"

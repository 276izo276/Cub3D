...
static void	move_x(t_map *map, t_mini *mini, int angle)
{
	double	dx;
...
static void	move_y(t_map *map, t_mini *mini, int angle)
{
	double	dy;
...
void	handle_move(t_map *map, t_mini *mini, int keycode)
{
	int	angle;

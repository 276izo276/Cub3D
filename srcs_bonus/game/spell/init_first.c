...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/10 07:51:15 by ale-guel          #+#    #+#             */
/*   Updated: 2025/12/10 07:51:16 by ale-guel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_incendio(t_data *data)
{
	...
	data->spell[INCENDIO].damage.damage_do = 5;
	...
	data->spell[INCENDIO].item.speed = 25;
...
void	init_repulso(t_data *data)
{
	...
	data->spell[REPULSO].item.speed = 20;
...
{
	data->spell[AGUAMENTI].base_cooldown = 4;

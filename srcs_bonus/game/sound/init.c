...
t_sound	*create_sound(t_data *data, int info)
{
	...
	if (sound->pid == 0)
	{
		...
		const char *tab[] = {LUMOS_MP3,ARANIA_EXUMAI_MP3,PROTEGO_MP3,INCENDIO_MP3,GLACIUS_MP3,REPULSO_MP3,AGUAMENTI_MP3,EXPELLIARMUS_MP3,EPISKEY_MP3,EXPECTO_PATRONUM_MP3,PETRIFICUS_TOTALUS_MP3,SERPENSORTIA_MP3,VENTUS_MP3,BOMBARDA_MP3,STUPEFIX_MP3,OPPUGNO_MP3,VULNERA_SANENTUR_MP3,VIPERA_EVANESCA_MP3,CONFUNDO_MP3,SECTUMSEMPRA_MP3,ENDOLORIS_MP3,AVADA_KEDAVRA_MP3,BACK_SOUND_MP3,THEME_HP_MP3,SHOOT_MP3,CRY_MP3,TP_MP3,DIE_MP3,PAPER_MP3, COLLECT_WAND_MP3, POPO_MP3, FREEDOM_MP3, FLOO_MP3, HEART_MP3, LVL_UP, WALL_MP3};
		if (info == 27)
			...
			execlp("cvlc", "cvlc", "--play-and-exit", "--quiet", "--loop", BACK_SOUND_MP3, (char *)NULL);
		else

...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   init_sorcerer_item.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: ale-guel <ale-guel@student.42lyon.fr>      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/10 07:49:05 by ale-guel          #+#    #+#             */
/*   Updated: 2025/12/10 07:49:06 by ale-guel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_marvin(t_data *data)
{
	...
	data->items[MARVIN].damage.slow_force_do = 35;
...
void	init_taylor_swift(t_data *data)
{
	...
	data->items[TAYLOR_SWIFT].damage.slow_force_do = 35;
...
void	init_company(t_data *data)
{
	...
	data->items[COMPANY].damage.slow_force_do = 35;
...
void	init_logo_42(t_data *data)
{
	...
	data->items[LOGO_42].damage.slow_force_do = 35;
